...
<body>
    ...
    <nav class="navbar">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a href="cadastrosAdm.php" class="nav-link">
    ...
    <main style="padding: 0">
        <div class="logo-nav" style="">
            <section>
                <ul class="nav-lateral">
                    <li> <i class="fa fa-bell fa-xs" aria-hidden="true"></i></li>
                    <li><i class="fa fa-comments-o fa-lg" aria-hidden="true"></i></li>
  ...
  <div class="coordenador">
      ...
      <img src="img/coordena.png" width="160px" height="160px">
      <br>
      ...
      <button name="button" class="button" onclick="document.getElementById('id01').style.display='block'">Cadastrar</button>
    ...
    <div class="w3-modal-content w3-animate-top w3-card-2">
      ...
      <div class="w3-container">
        ...
        <div class="coordenador2">
            <br>
            <div class="alinha">
                                           
                      <img src="img/X.png" width="10" height="10" align="right">
                         </div>
           <h4>Allan Vidal</h4>
          
      <img src="img/profile.png" width="110px" height="110px">
      <br>
            <br>
    <button name="button" class="button">Ver</button>
...
<hr>
      ...
      <img src="img/place.png" width="160px" height="160px">
      <br>
   
       
   

      <button name="button" class="button" onclick="document.getElementById('id02').style.display='block'">Cadastrar</button>
     ...
     <div class="coordenador2">
      ...
      <img src="img/anfiteatro.jpeg" width="110px" height="110px">
      <br>
            <br>
    <button name="button" class="button">Ver</button>
